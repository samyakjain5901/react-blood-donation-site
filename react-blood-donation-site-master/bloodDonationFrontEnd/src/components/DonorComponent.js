          ...
          <ModalBody>
            <FormText className="text-center" color="info">
              <strong>
                ...
                blood donor. Kindly update your date of donation once done, so
                that your name will be hidden automatically till next 3 Months.
                Also please update your profile/information if in case you
                relocate in future.
              </strong>
            </FormText>
            <br />
              ...
              <FormGroup row>
                <Label htmlFor="mobilenum" md={6}>
                  ...
                  <FormText color="primary">
                    (Don't add 0 before your number)
                  </FormText>
                </Label>
                <Col md={6}>
                  <Input
