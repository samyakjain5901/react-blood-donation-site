  ...
  return (
    <div style={{ backgroundColor: "#ccccb3" }}>
      <Jumbotron fluid>
        ...
        <p style={{ fontSize: "17px", lineHeight: "35px" }}>
          <strong>
            ...
            stock, the donors in mind are out of reach and the time keeps
            ticking? Have you witnessed loss of life for the only reason that a
            donor was not available at the most needed hour? Is it something
            that we as a society can do nothing to prevent? This thought laid
            our foundation. <br />
            Through this website, we seek donors who are willing to donate
            blood, as well as provide the timeliest support to those in frantic
            need of it.
          </strong>
        </p>
      </Jumbotron>
